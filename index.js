...
app.use(cors());
// app.use(cors({
//   origin:['https://server-site-navy.vercel.app'],
//   credentials: true,
// }))
app.use(express.json());

const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@cluster0.hnusrai.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
